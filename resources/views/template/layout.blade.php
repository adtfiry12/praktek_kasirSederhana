            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Pengguna</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{ url('pengguna/create') }}">Tambah Data Pengguna </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Pelanggan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('pelanggan') }}">Data Pelanggan</a></li>
                                <li><a href="{{ url('pelanggan/create') }}">Tambah Data Pelanggan </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Kategori</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{ url('kategori/create') }}">Tambah Data Kategori </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Barang</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('barang') }}">Data Barang</a></li>
                                <li><a href="{{ url('barang/create') }}">Tambah Data Barang </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-money"></i><span class="hide-menu">Transaksi</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{ url('transaksi/create') }}">Tambah Data Transaksi </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Laporan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('laporan') }}">Laporan Per Hari </a></li>
                                <li><a href="{{ url('laporan/create') }}">Laporan Per Bulan </a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
