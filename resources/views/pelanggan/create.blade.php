                                ...
                                <div class="basic-form">
                                    <form method="POST" action="{{ url('pelanggan/store') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_pelanggan" value="{{ $data }}" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea name="alamat" id="" cols="30" rows="50" class="form-control" placeholder="Masukan Alamat Anda"></textarea>
                                        </div>
                                        <div class="form-group">
